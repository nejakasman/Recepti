document.getElementById("prijavaObrazec").addEventListener("submit", async function (event) {
    event.preventDefault();

    const uporabniskoIme = document.getElementById("prijavaUporabniskoIme").value.trim();
