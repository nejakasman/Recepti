...
document.getElementById("registracijaObrazec").addEventListener("submit", async function (event) {
    event.preventDefault();

    const uporabniskoIme = document.getElementById("uporabniskoIme").value.trim();
